...
g = FootprintGen('QFN20_50x50_PAD')
...
padh = 0.55 + 0.4
pitch = 0.65
pad_from_cent = 4.5/2+0.2#wx / 2.0 + padh/2
x = 0
y = 0
for i in range(1, 6):
...
x = pitch * 2 + pad_from_cent
y = -pad_from_cent + pitch * 2
for i in range(6, 11):
...
g.rect_padat(2 * pitch, -pad_from_cent, 3.3, 3.3, '0')
