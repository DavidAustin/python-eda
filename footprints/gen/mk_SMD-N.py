...
make_fp(4, 2.5, 3.2, 2.2, 1.6, 1.4, 1.1) # based on https://www.raltron.com/webproducts/specs/CRYSTAL/RH100-32.000-6-F-1020-EXT-TR.pdf
    
make_fp(4, 2.5, 3.2, 2.3, 1.9, 1.3, 1.1) # based on https://ecsxtal.com/store/pdf/ECX-33QZ.pdf
